# -*- coding: utf-8 -*-
"""
Trains and tests an Autoregressive Integrated Moving Average model on data
...
series_plot(predict=predictions["Predict"], actual=predictions["Actual"], 
            title="ARIMA One-Step Ahead Rolling Forecast - Test",
            save=save_plot)
...
parity_plot(predict=predictions["Predict"], actual=predictions["Actual"],
            title="ARIMA Parity Plot - Test - R2: " + r2, save=save_plot)
